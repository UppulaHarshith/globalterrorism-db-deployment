...
weapon_fact_ingestion = DAG(  
    dag_id = 'weapon_pipeline',
...
START_OP = DummyOperator(task_id="START",
                         dag=weapon_fact_ingestion)




#The following operator applies transformation.sql script and pushes the data to a validation table
weapon_data_pipeline = BashOperator(
    task_id='weapon_data_ingestion',
    wait_for_downstream=False,
    bash_command='python3 /home/airflow/gcs/dags/weapon_pipeline.py',
    dag=weapon_fact_ingestion)


# validation_data_ingest_dag_pipeline
START_OP.set_downstream(weapon_data_pipeline)